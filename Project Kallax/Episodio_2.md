...
- [Allestiamo un nanoreef a basso costo - Project Kallax](#allestiamo-un-nanoreef-a-basso-costo---project-kallax)
  ...
  - [Testo](#testo)
    - [Intro](#intro)
    - [News da Project Kallax](#news-da-project-kallax)
    - [Vantaggi e svantaggi del nanoreef](#vantaggi-e-svantaggi-del-nanoreef)
    - [Concept vasca](#concept-vasca)
    - [Allestimento](#allestimento)
      - [Lavaggio vasche](#lavaggio-vasche)
      - [Rocciata](#rocciata)
...
Beh, questo è uno di quei casi in cui piccolo è meglio... ovviamente parliamo di Nanoreef!
...
Tutto procedeva bene insomma, ma mancava ovviamente qualcosa: quello spazio vuoto sul nostro amato mobile aveva assolutamente bisogno di essere riempito...
...
Infine, sono da non sottovalutare la necessità minima di spazio, e la praticità della manutenzione (cambiare 2lt d'acqua è sicuramente più comodo e veloce che cambiarne 30...)
Naturalmente non è tutto oro quel che luccica: i vantaggi ci sono, e sono innegabili, ma tutto ha un prezzo, e nel nostro caso, il prezzo è una maggiore dedizione dell'appassionato che dovrà prodigarsi il doppio per mantenere corretti, e soprattutto stabili, tutti quei i valori che per natura, in una massa d'acqua così piccola, sono tutt'altro che stabili.
...
Avere il filo esterno è una comodità, ma bisogna fare attenzione: questo osmoregolatore, infatti, per funzionare a dovere, richiede che i magneti siano perfettamente allineati, e questo ci ha fatto letteralmente impazire durante l'installazione. Un eventuale spostamento, anche di pochi millimetri, è sufficiente perchè il sensore smetta di funzionare correttamente, portando a conseguenze disastrose; quindi lo diciamo di nuovo: qualora voleste usarlo, fate attenzione!

Va detto che inserire un sistema di rabbocco automatico è effettivamente un po' contrario alla filosofia di "massima semplicità" che ci eravamo imposti in questa vasca, ma abbiamo deciso di farlo ugualmente, perchè in una vasca così piccola anche la minima variazione di livello può portare ad uno sbalzo notevole di salinità, ovviamente pericoloso per gli animali, ed è quindi necessario essere molto precisi; meglio affidare tutto ad un sistema automatico.

#### Illuminazione

Come ultimo step ci siamo occupati di installare la plafoniera. In questo caso, vista la dimensione della vasca e le pretese di allevamento non estreme, abbiamo preferito optare per qualcosa di piccolo, diminuendo i watt, e quindi i costi. 
Stiamo parlando di una Kessil A80 da 15W, che ci ha colpito per la qualità costruttiva, e soprattutto per la compattezza; ci è sembrata da subito perfetta per il nostro nanoreef, e la buona qualità dello spettro luminoso che un marchio blasonato come Kessil ci garantisce, dovrebbe permetterci di sfruttare appieno ogni singolo watt disponibile. Addirittura, nei forum stranieri, si legge di chi afferma di utilizzarla per allevare con successo SPS ed acropore, anche se noi, ovviamente, non intendiamo spingerci a tanto.
...
L'allestimento è terminato; e voi? cosa ne pensate? fateci sapere se questo nuovo progetto vi è piaciuto con un commento qui sotto. Noi ovviamente non mancheremo di tenervi aggiornati con tutti i progressi della vasca.

Anche per oggi è tutto, io vi saluto e vi do appuntamento al prossimo video.
Un salutone a tutti da Sharin. Ciaoooo!
