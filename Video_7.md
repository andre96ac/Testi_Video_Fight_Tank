...
## Gestione durante la maturazione

- Gestione illuminazione
- Somministazione di batteri
  
  
- Test / Valori
- triade
- Nutrire la vasca (fitoplanton + mangime)
- rottura crosta superficiale


- Cambi acqua dopo ciclo algale



- Qualcosa sul ciclo algale (time lapse)
...
- Aggiunto filtro calce sodata+
- Aggiunto controller alba-tramonto (modalità temporale)
- Aggiunto sistema per il balling


## Inserimenti

- Inserimento primi alghivori
...
#### Introduzione
Eccoci qui, dopo tre mesi dall'allestimento del nostro cubo marino di barriera; 
Facciamo un passo indietro, torniamo al primo giorno dopo l'allestimento, e vediamo com'è andata:

.............. {{Rewind}}

#### Illuminazione
Per cominciare l'illuminazione: per accellerare la maturazione abbiamo deciso, come è ormai consuetudine, di illuminare da subito la vasca, partendo direttamente con un fotoperiodo completo di 9 ore... In poche parole, la nostra plafoniera Nicrew ha dovuto fare gli straordinari.  Abbiamo preferito questa scelta con l'obiettivo di preservare il più possibile la fauna bentonica presente sulle rocce vive appena inserite, che, al buio, sarebbe sicuramente in parte morta. Ovviamente, così facendo, abbiamo dovuto accettare il rischio di una formazione molto più abbondante di alghe durante la fase di maturazione, ma a questo ci arriveremo tra poco...
...
Lo ribadiamo: è molto importante non esagerare ed attenersi alle dosi consigliate, per evitare che i batteri introdotti da noi vadano a sostituire completamente quelli presenti sulle rocce vive, vanificando quindi lo scopo.
...
Fortunatamente, nonostante l'accensione immediata delle luci, le alghe non hanno proliferato in maniera eccessiva, e soprattutto, il decorso dell'intero ciclo algale è stato relativamente rapido: abbiamo assistito alla comparsa delle prime alghe marroni, le comuni diatomee, già dopo una settimana dall'accensione delle luci. le stesse sono poi sparite da sole nel giro di circa 10gg, sostituite dalle altrettanto famose alghe filamentose verdi, che ci hanno fatto compagnia per circa una ventina di giorni, finendo poi per sbiancare e sparire gradualmente, una volta esauriti i nutrienti.
...
Per avere un'idea sull'andamento della maturazione, abbiamo effettuato tutti quanti i test: Ammoniaca, Nitriti, Nitrati, Fosfati, Silicati, Calcio, Magnesio, Kh.
...
Con il passare del tempo, abbiamo visto il formarsi, in vasca, di numerosi organismi più o meno vistosi: anfipodi, copepodi, asterinie, ofiure, ma anche spugne e spirografi. tutti meravigliosi, e fondamentali per la complessa catena alimentare che, così come succede in natura. Con il tempo siamo riusciti anche ad avvistare alcuni piccoli ospiti inaspettati, ma assolutamente graditi, tra cui una lumaca turbo, ed un piccolo granchio porcellana, che purtroppo è un po' timido e non ha voluto farsi riprendere.



Anche la sabbia inizia a mostrare i primi segni di maturazione: sulle superfici a contatto con il vetro iniziano a formarsi le tipiche macchie di alghe, e soprattutto, le bolle di azoto, segno che la denitrificazione stà avvenendo con successo. Si iniziano a vedere anche i primi cunicoli dei vermi scavatori, ovviamente importantissimi per il funzionamento del dsb; se volete saperne di più, abbiamo fatto un video apposta.
...
## Modifiche
Durante la maturazione non siamo stati con le mani in mano, e abbiamo apportato alcune modifiche e migliorie al sistema:
...
- Il movimento sulla superficie della sabbia non ci soddisfava, quindi abbiamo preferito aggiuntgere una terza pompa, per aumentare il flusso e migliorare la circolazione dei nutrienti tra la colonna d'acqua ed il fondo sabbioso.
